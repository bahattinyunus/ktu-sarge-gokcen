...
class TestRocketSimulation(unittest.TestCase):
    ...
    def test_apogee_positive(self):
        ...
        apogee = max(h)
        self.assertGreater(apogee, 0, "Apogee should be positive with sufficient thrust")
    ...
    def test_impact(self):
        ...
        t, h, v, a = simulate_flight(burn_time=2.0, avg_thrust=500, wet_mass=20.0, dry_mass=15.0)
